          ...
          <div className="flex items-center justify-center sm:justify-start md:justify-center mb-6 relative">
            ...
            <div className="absolute right-0 hidden sm:flex items-center">
              ...
              <div className="flex items-center space-x-4 -mb-2">
                <Link
                  href={`https://twitter.com/intent/tweet?text=${post.title}&url=https://innkba.com/lifestyle/${post.slug}`}
                  passHref
                >
                ...
                <Link
                  href={`https://www.facebook.com/sharer/sharer.php?u=https://innkba.com/lifestyle/${post.slug}`}
                  passHref
                >
                  <a target="_blank" rel="noopener noreferrer">
                ...
                <Link
                  href={`https://api.whatsapp.com/send?text=Mirá este artículo de Innk ba: https://innkba.com/lifestyle/${post.slug}`}
                  passHref
                >
                  <a target="_blank" rel="noopener noreferrer">
